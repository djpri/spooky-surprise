<!--
{
  ...
  "choices": [
    { "text": "Step into the vision fully", "next": "./prologue-elar-warning.md" },
    { "text": "Pull away; return to the chapel", "next": "./prologue.md" }
  ],
  "imagePath": null
}
-->

As your fingers close around the lens, the chapel tilts. For a moment—or a year—you're not alone.
